...
- **P4/Mininet chapters (3, 4, 5, 7)** require a working P4 toolchain (`p4c` compiler)
...
- **Ch.8, 9** are pure Python/ML projects and only need the pip packages in
...
| Ch. 7 | 97.4% accuracy at 28 ms median latency; 8% controller CPU load |
| Ch. 8 | Mamba+KAN+EWC: Ak = 78.38%, BWT = −21.99 on CIC-IoT2023 |
| Ch. 9 | PBR achieves 99.4% on CICIDS2017; cross-dataset accuracy 25.32% |
...
|---|---|---|
| CIC-DDoS2019 | Ch. 3, 4, 5, 7, 9 | https://www.unb.ca/cic/datasets/ddos-2019.html |
| CICIDS2017 | Ch. 8, 9 | https://www.unb.ca/cic/datasets/ids-2017.html |
| CIC-IoT2023 | Ch. 8 | https://www.unb.ca/cic/datasets/iotdataset-2023.html |
| ToN-IoT | Ch. 8 | https://research.unsw.edu.au/projects/toniot-datasets |
| Kaggle DDoS SDN | Ch. 9 | [https://www.kaggle.com/datasets/](https://www.kaggle.com/datasets/dhoogla/cicddos2019) |
